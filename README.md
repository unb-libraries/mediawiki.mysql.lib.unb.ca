# mediawiki.mysql.lib.unb.ca : Instance Repository
[![Build Status](https://travis-ci.com/unb-libraries/lib.unb.ca.svg?branch=prod)](https://travis-ci.com/unb-libraries/mediawiki.mysql.lib.unb.ca) [![GitHub license](https://img.shields.io/github/license/unb-libraries/mediawiki.mysql.lib.unb.ca)](https://github.com/unb-libraries/mediawiki.mysql.lib.unb.ca/blob/dev/LICENSE) ![GitHub repo size](https://img.shields.io/github/repo-size/unb-libraries/mediawiki.mysql.lib.unb.ca)

This repository contains all assets used to test, build, and deploy the mediawiki.mysql.lib.unb.ca database server, the database that drives [unbhistory.lib.unb.ca](https://unbhistory.lib.unb.ca).
